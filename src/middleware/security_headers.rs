...
pub async fn layer(request: Request<Body>, next: Next) -> Response {
    ...
    #[allow(clippy::unwrap_used)]
    {
        ...
        headers.insert(
            ...
            "default-src 'self'; script-src 'self' https://unpkg.com https://analytics.osmosis.page 'unsafe-inline'; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com; img-src 'self' data: https://static.osmosis.page; connect-src 'self' https://analytics.osmosis.page https://openrouter.ai https://notifications.osmosis.page; frame-ancestors 'none'"
                .parse()
                .unwrap(),
        );
    }
